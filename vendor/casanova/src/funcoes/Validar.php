...
/**
 * Validar
 * @category Funcões para validação de informações
...
class Validar{
     ...
     */
    public static function telefoneCelular($telefone){
        $telefone = Formatar::telefone($telefone);
     ...
     /**
     * mobile
     * @category Verifica se o site está rodando em um telefone celular
     * @author Renato Félix de Almeida <email@email.com>
     * @copyright 2020 Casa Nova Locadora
     * @return bool se está em telefone celular
     */
